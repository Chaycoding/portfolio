...
function Newestposts() {
  return (
    <div className="mt-10 grid grid-cols-1 mx-20 ">
      ...
      <div className="text-3xl flex justify-center pb-14">
      ...
      <div className="hover:outline-1 mt-16 hover:outline hover:outline-blue-400 rounded-lg flex p-2">
        ...
        >
          ...
          <div className="basis-2/6 text-lg text-red-500 flex flex-col justify-center ">
            <div className="w-full bg-compassion bg-center transition-all rounded-xl h-48 bg-cover "></div>
        ...
        >
          <div className="basis-4/6 pr-5  ">
            ...
            <p className="text-lg mt-3 ">
              ...
              project it is one of the best ways to learn how to work with APIs.
              Now being able to an API is an extremely important skill I wanted
              build. This project primarily centers around API usage.
              <br />
              <br />
              The API is the openweather API. I wanted to make this a simple
              site that just fulfills the necessity of getting the weather. The
              additional animations of course make it a sweeter user experience.
              The clock present on the right side of the header is something I
              am happy about. Although it is simple it is very cool to just
              access the time and the location of the user. Of course in the
              real world this should be differently. The site additionally shows
              a prediction of the weather for the next five days as well as more
              weather details.
            </p>
          </div>

          <div className="basis-2/6 text-lg text-red-500 flex flex-col justify-center ">
            <div className="w-full bg-weather bg-right transition-all rounded-xl h-48 bg-cover"></div>
